...
#ifndef _MOEX_SPECTRA_SIMBA_DECIMAL5NULL_H_
#define _MOEX_SPECTRA_SIMBA_DECIMAL5NULL_H_
...
public:
    ...
    Decimal5NULL(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        Decimal5NULL(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    Decimal5NULL(
        char *buffer,
        const std::uint64_t bufferLength) :
        Decimal5NULL(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    Decimal5NULL &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Decimal5NULL(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    {
        return INT64_C(9223372036854775806);
    }
    ...
    Decimal5NULL &mantissa(const std::int64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    {
        return static_cast<std::int8_t>(-5);
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Decimal5NULL writer)
{
    builder << '{';
    builder << R"("mantissa": )";
