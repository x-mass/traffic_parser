...
#ifndef _MOEX_SPECTRA_SIMBA_ORDEREXECUTION_H_
#define _MOEX_SPECTRA_SIMBA_ORDEREXECUTION_H_
...
public:
    ...
    OrderExecution(char *buffer, const std::uint64_t bufferLength) :
        OrderExecution(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderExecution(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderExecution(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    OrderExecution &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = OrderExecution(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    OrderExecution &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    OrderExecution &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = OrderExecution(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        OrderExecution skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    OrderExecution &mDEntryID(const std::int64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    OrderExecution &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    SBE_NODISCARD Decimal5 &lastPx()
    {
        m_lastPx.wrap(m_buffer, m_offset + 24, m_actingVersion, m_bufferLength);
        return m_lastPx;
    }
...
#pragma clang diagnostic pop
    ...
    static SBE_CONSTEXPR std::int64_t lastQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t lastQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t lastQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }
    ...
    SBE_NODISCARD std::int64_t lastQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    OrderExecution &lastQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
#pragma clang diagnostic pop
    ...
    OrderExecution &tradeID(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_mDFlags.wrap(m_buffer, m_offset + 48, m_actingVersion, m_bufferLength);
        return m_mDFlags;
    }
...
public:
    ...
    {
        m_mDFlags2.wrap(m_buffer, m_offset + 56, m_actingVersion, m_bufferLength);
        return m_mDFlags2;
    }
...
#pragma clang diagnostic pop
    ...
    OrderExecution &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 68, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    OrderExecution &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 68, &val, sizeof(std::uint32_t));
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    OrderExecution &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    OrderExecution &mDEntryType(const MDEntryType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, OrderExecution _writer)
{
    OrderExecution writer(_writer.m_buffer, _writer.m_offset,
        _writer.m_bufferLength, _writer.sbeBlockLength(), _writer.m_actingVersion);
    builder << '{';
    builder << R"("Name": "OrderExecution", )";
