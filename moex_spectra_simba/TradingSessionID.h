...
#ifndef _MOEX_SPECTRA_SIMBA_TRADINGSESSIONID_H_
#define _MOEX_SPECTRA_SIMBA_TRADINGSESSIONID_H_
...
public:
    enum Value
    {
        ...
        Morning = static_cast<std::uint8_t>(3),
        Evening = static_cast<std::uint8_t>(5),
    ...
    static TradingSessionID::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(3): return Morning;
            case static_cast<std::uint8_t>(5): return Evening;
