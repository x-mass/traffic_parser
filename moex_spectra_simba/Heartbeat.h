...
#ifndef _MOEX_SPECTRA_SIMBA_HEARTBEAT_H_
#define _MOEX_SPECTRA_SIMBA_HEARTBEAT_H_
...
public:
    ...
    {
        return *this = Heartbeat(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    Heartbeat &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Heartbeat(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        Heartbeat skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Heartbeat _writer)
{
    Heartbeat writer(_writer.m_buffer, _writer.m_offset,
