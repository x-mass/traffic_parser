...
#ifndef _MOEX_SPECTRA_SIMBA_DECIMAL5_H_
#define _MOEX_SPECTRA_SIMBA_DECIMAL5_H_
...
public:
    ...
    Decimal5(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        Decimal5(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    Decimal5(
        char *buffer,
        const std::uint64_t bufferLength) :
        Decimal5(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    Decimal5 &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Decimal5(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    Decimal5 &mantissa(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Decimal5 writer)
{
    builder << '{';
    builder << R"("mantissa": )";
