...
#ifndef _MOEX_SPECTRA_SIMBA_EMPTYBOOK_H_
#define _MOEX_SPECTRA_SIMBA_EMPTYBOOK_H_
...
public:
    ...
    EmptyBook(char *buffer, const std::uint64_t bufferLength) :
        EmptyBook(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    EmptyBook(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        EmptyBook(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    EmptyBook &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = EmptyBook(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    EmptyBook &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    EmptyBook &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = EmptyBook(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        EmptyBook skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    EmptyBook &lastMsgSeqNumProcessed(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, EmptyBook _writer)
{
    EmptyBook writer(_writer.m_buffer, _writer.m_offset,
        _writer.m_bufferLength, _writer.sbeBlockLength(), _writer.m_actingVersion);
    builder << '{';
    builder << R"("Name": "EmptyBook", )";
