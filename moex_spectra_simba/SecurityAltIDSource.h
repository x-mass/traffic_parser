...
#ifndef _MOEX_SPECTRA_SIMBA_SECURITYALTIDSOURCE_H_
#define _MOEX_SPECTRA_SIMBA_SECURITYALTIDSOURCE_H_
...
public:
    enum Value
    {
        ...
        ExchangeSymbol = static_cast<char>(56),
        NULL_VALUE = static_cast<char>(0)
    };

    static SecurityAltIDSource::Value get(const char value)
    {
        switch (value)
        {
            case static_cast<char>(52): return ISIN;
            case static_cast<char>(56): return ExchangeSymbol;
    ...
    static const char *c_str(const SecurityAltIDSource::Value value)
    {
        switch (value)
        {
            ...
            case ExchangeSymbol: return "ExchangeSymbol";
