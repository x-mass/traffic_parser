...
#ifndef _MOEX_SPECTRA_SIMBA_DECIMAL2NULL_H_
#define _MOEX_SPECTRA_SIMBA_DECIMAL2NULL_H_
...
public:
    ...
    Decimal2NULL(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        Decimal2NULL(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    Decimal2NULL(
        char *buffer,
        const std::uint64_t bufferLength) :
        Decimal2NULL(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    Decimal2NULL &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Decimal2NULL(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    Decimal2NULL &mantissa(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Decimal2NULL writer)
{
    builder << '{';
    builder << R"("mantissa": )";
