...
#ifndef _MOEX_SPECTRA_SIMBA_MDENTRYTYPE_H_
#define _MOEX_SPECTRA_SIMBA_MDENTRYTYPE_H_
...
public:
    ...
    static MDEntryType::Value get(const char value)
    {
        switch (value)
        {
            ...
            case static_cast<char>(74): return EmptyBook;
    ...
    static const char *c_str(const MDEntryType::Value value)
    {
        switch (value)
        {
            ...
            case EmptyBook: return "EmptyBook";
