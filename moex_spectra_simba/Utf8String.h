...
#ifndef _MOEX_SPECTRA_SIMBA_UTF8STRING_H_
#define _MOEX_SPECTRA_SIMBA_UTF8STRING_H_
...
public:
    ...
    Utf8String(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        Utf8String(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    Utf8String(
        char *buffer,
        const std::uint64_t bufferLength) :
        Utf8String(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    Utf8String &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Utf8String(buffer, offset, bufferLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    Utf8String &length(const std::uint16_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits>& operator << (
    std::basic_ostream<CharT, Traits>& builder, Utf8String writer)
{
    builder << '{';
    builder << R"("length": )";
